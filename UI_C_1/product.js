...
radi.addEventListener('change',(e)=>{
    ...
    imged.src = "img/"+ e.target.value + ".jpeg";
    ...
    document.querySelector(".img-ccc img").src = "img/" + e.target.value + "3.jpeg";
    document.querySelector(".const img").src="img/" + e.target.value + "2.jpeg";
